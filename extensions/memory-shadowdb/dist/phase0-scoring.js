 ...
 */
export function computeRecordConfidence(record, asOf = new Date()) {
 ...
 */
export function assignRelevanceTier(documentDate, asOf = new Date()) {
 ...
 */
export function resolveDecayProfile(recordType, category) {
 ...
 */
export function filterByTier(candidates, includeArchived = false) {
    return candidates.filter((r) => {
        if (r.isTimeless)
            return true;
        if (r.relevanceTier === null)
            return includeArchived;
        return true;
    });
}
//# sourceMappingURL=phase0-scoring.js.map