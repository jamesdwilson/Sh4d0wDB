            ...
            const memorySearchTool = {
                ...
                execute: async (_toolCallId, params) => {
                    ...
                    if (params.record_type)
                        filters.record_type = params.record_type;
                    if (params.tags_include)
                        filters.tags_include = params.tags_include;
                    if (params.tags_any)
                        filters.tags_any = params.tags_any;
                    if (params.priority_min !== undefined)
                        filters.priority_min = params.priority_min;
                    ...
                    const detailLevel = params.detail_level;
