...
export function extractEntities(tags: string[]): string[] {
  return tags
...
export function extractEntitiesFromText(content: string, knownEntities: string[]): string[] {
  const found: string[] = [];
 ...
 */
export async function mapEventToContacts(
  eventTags: string[],
  eventContent: string,
  knownEntities: string[],
  queryContactsFn: (entitySlug: string) => Promise<Array<{ id: number }>>,
